...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--phase1-from", type=str, default="2023-01-01")
        parser.add_argument("--phase1-to", type=str, default="2024-12-31")
        parser.add_argument("--phase2-from", type=str, default="2024-01-01")
