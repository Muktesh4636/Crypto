...
# Historical news / macro ingestion (optional; see management commands).
# Register free keys at: https://open-platform.theguardian.com/ — https://fred.stlouisfed.org/docs/api/api_key.html
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-h!6#esx(oj851-4zt5^-j%v=3&_2%k%wqa%pd@xclp@un6g8$9",
)
...
POSTGRES_HOST = os.environ.get("POSTGRES_HOST", "127.0.0.1").strip() or "127.0.0.1"
